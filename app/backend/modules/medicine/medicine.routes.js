...
router.post("/quick", medicineController.quickCreate.bind(medicineController));
router.get("/", medicineController.findAll.bind(medicineController));
router.get("/group/:id", medicineController.findGroupedById.bind(medicineController));
