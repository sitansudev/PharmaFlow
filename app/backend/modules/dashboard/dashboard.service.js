...
export class DashboardService {
    async getStats() {
        ...
        const [totalMedicines, totalCategories, totalSuppliers, totalCustomers, totalSales, totalPurchases, lowStockMedicines, expiringBatches, expiredBatches, recentSales, recentPurchases,] = await Promise.all([
