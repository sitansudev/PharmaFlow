...
export class ReportsService {
    async dashboardSummary() {
        ...
        const lowStockCount = medicines.filter((m) => m.stock <= m.minimumStock).length;
        const [medicineCount, categoryCount, supplierCount, customerCount, totalSales, totalPurchases, expiringCount, expiredCount,] = await Promise.all([
