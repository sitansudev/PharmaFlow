...
router.get("/:id/ledger", supplierLedgerController.getLedger.bind(supplierLedgerController));
router.post("/:id/ledger/payment", supplierLedgerController.createPayment.bind(supplierLedgerController));
